...
\section{6.6.A.}
\begin{proof}
	Taking contrapositives for both directions. 
	For $\mathfrak p\in\Spec A$ such that $m_{\mathfrak p}=0$, there exists $q\notin\mathfrak p$ such that 
	\[q m=0\in M.\] But this contradicts that $q\in \Ann m\subset \mathfrak p$.

	And we notice the argument above is reversible.
\end{proof}
\section{6.6.B.}
