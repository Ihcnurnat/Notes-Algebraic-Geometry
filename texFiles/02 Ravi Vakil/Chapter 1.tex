...
\section{1.2.10.}
\begin{proposition}
In the category of divisible groups, the map $\mathbb Q\to \mathbb Q/\mathbb Z$ is a monomorphism.
\end{proposition}
For divisible groups, here we may consider it as abelian groups that are divisible. Thus we've obtained a full subcategory of an Abelian category. We thus consider ... 
One important fact is to realise the subgroup of $\mathbb Z$ that is divisible is $0$. 
